...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./image/zeroyt7.jpg'), surface: 200, message: `𝑮𝒂𝒗𝒖𝒆𝒍'𝒔`, orderTitle: 'Please Subscribe Youtube Zero YT7', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/ytMp4', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒇𝒐𝒍𝒍𝒐𝒘 𝒎𝒚 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 @2𝒌𝒂𝒏𝒈𝒔𝒐𝒖𝒍_`}, { quoted: ftroli })
}
break
case 'ytmp3': {
if (!text) throw 'Masukkan Link Youtube Nya'
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/tiktokvideo', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.nowm }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒇𝒐𝒍𝒍𝒐𝒘 𝒎𝒚 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 @2𝒌𝒂𝒏𝒈𝒔𝒐𝒖𝒍_`}, { quoted: ftroli })
}
break
case 'wm': {
if (!text) throw 'Masukkan Link Tiktok Nya'
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/tiktokvideo', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.wm }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒇𝒐𝒍𝒍𝒐𝒘 𝒎𝒚 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 @2𝒌𝒂𝒏𝒈𝒔𝒐𝒖𝒍_`}, { quoted: ftroli })
}
break
case 'mediafiredl': {
...
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result.link }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒇𝒐𝒍𝒍𝒐𝒘 𝒎𝒚 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 @2𝒌𝒂𝒏𝒈𝒔𝒐𝒖𝒍_`}, { quoted: ftroli })
}
break
case 'igvideo': {
...
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.link }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒇𝒐𝒍𝒍𝒐𝒘 𝒎𝒚 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 @2𝒌𝒂𝒏𝒈𝒔𝒐𝒖𝒍_`}, { quoted: ftroli })
}
break
...
zeroyt7.sendMessage(m.chat, {image: webapi, caption: `Done Nih... Jangan Lupa Subscibe Zero YT7`}, {quoted:ftroli})
}
break
case 'blackpink':
case 'neon':
...
zeroyt7.sendMessage(m.chat, { image: { url: webapi.data }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
...
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.url }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
case 'cewekchina':
case 'cewekindonesia':
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', `/${command}`, {}, 'apikey'))
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result.url }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', `/${command}`, {}, 'apikey'))
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
case 'xnxxsearch': {
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/xnxxdl', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.files.low }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
case 'high': {
if (!text) throw 'Link Video Bokep Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/xnxxdl', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.files.high }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
case 'hls': {
if (!text) throw 'Link Video Bokep Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/xnxxdl', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.files.hls }, caption: `Done Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
...
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result.url }, caption: `Author : ${webapi.result.author}\nDone Nih... Don't forget to follow my instagram @2kangsoul`}, { quoted: ftroli })
}
break
case 'linkwa': {
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', `/${command}`, {},'apikey'))
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result.url }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒇𝒐𝒍𝒍𝒐𝒘 𝒎𝒚 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 @2𝒌𝒂𝒏𝒈𝒔𝒐𝒖𝒍_`}, { quoted: ftroli })
}
break
